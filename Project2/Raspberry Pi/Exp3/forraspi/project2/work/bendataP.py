...
class benddata():
    ...
    def bendframe(self):
        ...
        frame4.grid(row=0,column=0,ipadx=10,sticky="w")
        ...
        Button(frame6, image=homeimg, command=pBrake,highlightthickness=0, borderwidth=0,bg="#b3ffe0").grid(row=0, column=0,padx=20)
        ...
        Button(frame6, image=pgimg, command=prog,font="Calibri 13 bold", highlightthickness=0, borderwidth=0,bg="#b3ffe0").grid(row=0, column=1,padx=20)
        pglimg = ImageTk.PhotoImage(
            Image.open('programlist.png').resize((150, 90), Image.LANCZOS))
        # pdlabel=Label(frame6,image=pdimg).grid(row=0,column=1,padx=50,columnspan=2)
        Button(frame6, image=pglimg, command=pgList,highlightthickness=0, borderwidth=0,bg="#b3ffe0").grid(row=0, column=2,padx=20)
        ...
        Button(frame6, image=plimg, command=op,highlightthickness=0, borderwidth=0,bg="#b3ffe0").grid(row=0, column=4,padx=20)
