...
class operation():
    ...
    def operationframe(self):
        ...
        Label(framei1, text="Angle", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        anglev = StringVar()
        ag = yy[1]
        anglev.set(ag)
        Entry(framei1, width=8, textvariable=anglev, font="Arial_Black 11 bold", ).grid(row=0, column=1)

        Label(framei1, text="Length", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=1, column=0)
        lengthv = StringVar()
        lgt = yy[2]
        lengthv.set(lgt)
        Entry(framei1, width=8, textvariable=lengthv, font="Arial_Black 11 bold", ).grid(row=1, column=1)
        Label(framei1, text="B.Gauge", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=2, column=0)
        bgaugev = StringVar()
        bg = yy[3]
        bgaugev.set(bg)
        Entry(framei1, width=8, textvariable=bgaugev, font="Arial_Black 11 bold", ).grid(row=2, column=1)
        Label(framei1, text="Retract", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=3, column=0)
        retractv = StringVar()
        rt = yy[4]
        retractv.set(rt)
        Entry(framei1, width=8, textvariable=retractv, font="Arial_Black 11 bold", ).grid(row=3, column=1)
        Label(framei1, text="Opening", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=4, column=0)
        openingv = StringVar()
        opn = yy[5]
        openingv.set(opn)
        Entry(framei1, width=8, textvariable=openingv, font="Arial_Black 11 bold", ).grid(row=4, column=1)
        Label(framei1, text="R Position", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=5, column=0)
        rpositionv = StringVar()
        rp = yy[6]
        rpositionv.set(rp)
        Entry(framei1, width=8, textvariable=rpositionv, font="Arial_Black 11 bold", ).grid(row=5, column=1)
        Label(framei1, text="Thick", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=6, column=0)
        thickv = StringVar()
        th = yy[7]
        thickv.set(th)
        Entry(framei1, width=8, textvariable=thickv, font="Arial_Black 11 bold", ).grid(row=6, column=1)
        Label(framei1, text="Force", font="Calibri 12 bold", padx=4,pady=5, bg="#b3ffe0",
              fg="blue").grid(row=7, column=0)
        forcev = StringVar()
        fc = yy[8]
        forcev.set(fc)
        Entry(framei1, width=8, textvariable=forcev, font="Arial_Black 11 bold", ).grid(row=7, column=1)
        ...
        Label(frameA, text="Programme", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        prgno = StringVar()
        pgno = yy[9]
        prgno.set(pgno)
        Label(frameA, textvariable=prgno, font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
        ...
        Label(frameB1i, text="Last Force", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        lastforcev = StringVar()
        lfc = yy[10]
        lastforcev.set(lfc)
        Entry(frameB1i, width=8, textvariable=lastforcev, font="Arial_Black 11 bold", ).grid(row=0, column=1)

        Label(frameB1i, text="Pinch", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=1, column=0)
        pinchv = StringVar()
        pnch = yy[12]
        pinchv.set(pnch)
        Entry(frameB1i, width=8, textvariable=pinchv, font="Arial_Black 11 bold", ).grid(row=1, column=1)
        frameB1i.grid(row=0)
        frameBend = Frame(frameB1, bg="#b3ffe0")
        Label(frameBend, text="Bend", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        bendv = StringVar()
        bd1 = yy[13]
        bendv.set(bd1)

        Entry(frameBend, width=3, textvariable=bendv, font="Arial_Black 11 bold", ).grid(row=0, column=1)
        Label(frameBend, text="/", font="Calibri 7 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=2)
        bend2v = StringVar()
        bd2 = yy[14]
        bend2v.set(bd2)
        Entry(frameBend, width=3, textvariable=bend2v, font="Arial_Black 11 bold", ).grid(row=0, column=3)
        frameBend.grid(row=2)
        frameB1ii = Frame(frameB1, bg="#b3ffe0")
        Label(frameB1ii, text="Dwell", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        dwellv = StringVar()
        dw = yy[15]
        dwellv.set(dw)
        Entry(frameB1ii, width=8, textvariable=dwellv, font="Arial_Black 11 bold", ).grid(row=0, column=1)
        frameB1ii.grid(row=3)
        frameB1iii = Frame(frameB1, bg="#b3ffe0")
        Label(frameB1iii, text="X", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        ...
        xv = yy[16]
        xvv.set(xv)
        Entry(frameB1iii, width=8, textvariable=xvv, font="Arial_Black 11 bold", ).grid(row=0, column=2)
        Label(frameB1iii, text="R", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=1, column=0)
        ...
        rv = yy[17]
        rvv.set(rv)
        Entry(frameB1iii, width=8, textvariable=rvv, font="Arial_Black 11 bold", ).grid(row=1, column=2)
        Label(frameB1iii, text="Y", font="Calibri 12 bold", padx=4, pady=5, bg="#b3ffe0",
              fg="blue").grid(row=2, column=0)
        ...
        yv = yy[18]
        yvv.set(yv)
        Entry(frameB1iii, width=8, textvariable=yvv, font="Arial_Black 11 bold", ).grid(row=2, column=2)
        ...
        afc = yy[11]
        actforcev.set(afc)
        Entry(frameB2i, width=8, textvariable=actforcev, font="Arial_Black 11 bold", ).grid(row=0, column=1)
        Label(frameB2i, text="(Ton)", font="Calibri 7 bold", padx=7, pady=7, bg="#b3ffe0",
              fg="blue").grid(row=0, column=2)
        frameB2i.grid(row=0 )
        ...
        ct = yy[19]
        countv.set(ct)
        Entry(framei3, width=9, textvariable=countv, font="Arial_Black 11 bold", ).grid(row=2,sticky="w",pady=5,padx=5)
        ...
        Label(framesp, text="Speed", font="Calibri 11 bold", padx=4, pady=7, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        spv = StringVar()
        sp = yy[20]
        spv.set(sp)
        Entry(framesp, width=6, textvariable=spv, font="Arial_Black 11 bold").grid(row=0, column=1)
        Label(framesp, text="(mm/s)", font="Calibri 6 bold", padx=4, pady=7, bg="#b3ffe0",
              fg="blue").grid(row=0, column=2)
        ...
        Label(frame5, text="Emergency Swtich Pressed...", font="Calibri 7 bold", padx=7, pady=7, bg="#b3ffe0",
              fg="blue").grid(row=0, column=0)
        ...
        homeimg = ImageTk.PhotoImage(
            Image.open('home.png').resize((130, 90), Image.LANCZOS))
        # settinglabel=Label(frame6,image=settingimg).grid(row=0,column=0,padx=50)
        Button(frame6, image=homeimg, command=pBrake, highlightthickness=0, borderwidth=0, bg="#b3ffe0").grid(row=0, column=0, padx=15,pady=3.5)
        lrimg = ImageTk.PhotoImage(
            Image.open('arrow1.png').resize((130, 90), Image.LANCZOS))
        # pdlabel=Label(frame6,image=pdimg).grid(row=0,column=1,padx=50,columnspan=2)
        Button(frame6, image=lrimg, command=minus,font="Calibri 12 bold", highlightthickness=0, borderwidth=0, bg="#b3ffe0").grid(row=0, column=1, padx=15,pady=3.5)
        Label(frame6, textvariable=opno,font="Calibri 12 bold",bg="#b3ffe0",fg="blue").grid(row=0, column=2, padx=50,pady=3.5)
        rrimg = ImageTk.PhotoImage(
            Image.open('arrow.png').resize((130, 90), Image.LANCZOS))
        # pdlabel=Label(frame6,image=pdimg).grid(row=0,column=1,padx=50,columnspan=2)
        Button(frame6, image=rrimg,  command=plus,highlightthickness=0, borderwidth=0, bg="#b3ffe0").grid(row=0, column=3, padx=15,pady=3.5)
        pgimg = ImageTk.PhotoImage(
            Image.open('program.png').resize((130, 90), Image.LANCZOS))
        Button(frame6, image=pgimg, command=prog, highlightthickness=0, borderwidth=0, bg="#b3ffe0").grid(row=0, column=4, padx=15,pady=3.5)
