...
class punchList():
    ...
    def punchListFrame(self):
        ...
        Label(frame3, text="No.", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
                                                                                                            column=0)
        Label(frame3, text="Name", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
                                                                                                             column=1)
        Label(frame3, text="Height", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
                                                                                                               column=2)
        Label(frame3, text="Angel", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
                                                                                                              column=3)
        Label(frame3, text="Radius", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
                                                                                                               column=4)
        Label(frame3, text="No.", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
                                                                                                            column=5)
        Label(frame3, text="Name", font="Stencil 15 bold", padx=3, pady=10, bg="#ccffff", fg="#e68a00").grid(row=0,
        ...
        r1 = StringVar()
        r1.set(rs1[4])
        Entry(frame3, textvariable=n1, font="Calibri 11", width=9).grid(row=1, column=1)
        ...
        Label(frame3, text="6", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=1,
                                                                                                          column=5)
        rs6 = myresult[5]
        n6 = StringVar()
        n6.set(rs6[1])
        ...
        r6 = StringVar()
        r6.set(rs6[4])
        Entry(frame3, textvariable=n6, font="Calibri 11", width=9).grid(row=1, column=6)
        ...
        # 2,7
        Label(frame3, text="2", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=2,
                                                                                                          column=0)
        rs2 = myresult[1]
        n2 = StringVar()
        n2.set(rs2[1])
        ...
        r2 = StringVar()
        r2.set(rs2[4])
        Entry(frame3, textvariable=n2, font="Calibri 11", width=9).grid(row=2, column=1)
        ...
        Label(frame3, text="7", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=2,
                                                                                                          column=5)
        rs7 = myresult[6]
        n7 = StringVar()
        n7.set(rs7[1])
        ...
        r7 = StringVar()
        r7.set(rs7[4])
        Entry(frame3, textvariable=n7, font="Calibri 11", width=9).grid(row=2, column=6)
        ...
        # 3,8
        Label(frame3, text="3", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=3,
                                                                                                          column=0)
        rs3 = myresult[2]
        n3 = StringVar()
        n3.set(rs3[1])
        ...
        r3 = StringVar()
        r3.set(rs3[4])
        Entry(frame3, textvariable=n3, font="Calibri 11", width=9).grid(row=3, column=1)
        ...
        Label(frame3, text="8", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=3,
                                                                                                          column=5)
        rs8 = myresult[7]
        n8 = StringVar()
        n8.set(rs8[1])
        ...
        r8 = StringVar()
        r8.set(rs8[4])
        Entry(frame3, textvariable=n8, font="Calibri 11", width=9).grid(row=3, column=6)
        ...
        # 4,9
        Label(frame3, text="4", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=4,
                                                                                                          column=0)
        rs4 = myresult[3]
        n4 = StringVar()
        n4.set(rs4[1])
        ...
        r4 = StringVar()
        r4.set(rs4[4])
        Entry(frame3, textvariable=n4, font="Calibri 11", width=9).grid(row=4, column=1)
        ...
        Label(frame3, text="9", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=4,
                                                                                                          column=5)
        rs9 = myresult[8]
        n9 = StringVar()
        n9.set(rs9[1])
        ...
        r9 = StringVar()
        r9.set(rs9[4])
        Entry(frame3, textvariable=n9, font="Calibri 11", width=9).grid(row=4, column=6)
        ...
        # 5,10
        Label(frame3, text="5", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=5,
                                                                                                          column=0)
        rs5 = myresult[4]
        n5 = StringVar()
        n5.set(rs5[1])
        ...
        r5 = StringVar()
        r5.set(rs5[4])
        Entry(frame3, textvariable=n5, font="Calibri 11", width=9).grid(row=5, column=1)
        ...
        Label(frame3, text="10", font="Stencil 12 bold", padx=3, pady=10, bg="#b3ffe0", fg="#e68a00").grid(row=5,
                                                                                                           column=5)
        rs10 = myresult[9]
        n10 = StringVar()
        n10.set(rs10[1])
        ...
        r10 = StringVar()
        r10.set(rs10[4])
        Entry(frame3, textvariable=n10, font="Calibri 11", width=9).grid(row=5, column=6)
        ...
        homeimg = ImageTk.PhotoImage(
            Image.open('home.png').resize((120, 80), Image.LANCZOS))
        # settinglabel=Label(frame6,image=settingimg).grid(row=0,column=0,padx=50)
        Button(frame6, image=homeimg, command=pBrake,bg="#b3ffe0", highlightthickness=0,borderwidth=0).grid(row=0, column=0, padx=50)
        pdimg = ImageTk.PhotoImage(
            Image.open('punchdata.png').resize((120, 80), Image.LANCZOS))
        # pdlabel=Label(frame6,image=pdimg).grid(row=0,column=1,padx=50,columnspan=2)
        Button(frame6, image=pdimg, command=pnData,bg="#b3ffe0", highlightthickness=0,borderwidth=0).grid(row=0, column=1, padx=50, columnspan=2)
        opimg = ImageTk.PhotoImage(
            Image.open('operation.png').resize((120, 80), Image.LANCZOS))
        # pllabel=Label(frame6,image=plimg).grid(row=0,column=4,padx=50,columnspan=2)
        Button(frame6, image=opimg, command=op,bg="#b3ffe0", highlightthickness=0,borderwidth=0).grid(row=0, column=4, padx=50, columnspan=2)
